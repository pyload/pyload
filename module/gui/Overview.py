...
class OverviewModel(QAbstractListModel):
    ...
    def data(self, index, role=Qt.DisplayRole):
        if role in [OverviewModel.PackageName, OverviewModel.Progress, OverviewModel.PartsFinished, OverviewModel.Parts,
                    OverviewModel.ETA, OverviewModel.Speed, OverviewModel.CurrentSize, OverviewModel.MaxSize,
...
class OverviewDelegate(QItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        newr = painter.boundingRect(r.left(), newr.bottom() + 2, r.width(), r.height(), Qt.AlignTop | Qt.AlignLeft,
                                    statusline)
