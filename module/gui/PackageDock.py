...
from PyQt4.QtGui import (QCheckBox, QColor, QDockWidget, QGridLayout, QHBoxLayout, QIcon, QLabel, QLineEdit, QPlainTextEdit, QPushButton,
                         QRadioButton, QSizePolicy, QTextCursor, QVBoxLayout, QWidget)
