...
class HTTPRequest(object):
    ...
    def _parse_request(self):
        ...
        self.response_protocol = "HTTP/{}.{}".format(min(rp, sp))
...
##            if line: chunk_extension = line[0]
    ...
    def simple_response(self, status, msg=""):
        ...
        status = str(status)
        buf = ["{} {}\r\n".format(self.environ['ACTUAL_SERVER_PROTOCOL'], status),
               "Content-Length: {}\r\n".format(len(msg),)
            ...
            if size < 0:
                ...
                while True:
                    ...
                    if n == left:
                        ...
                        break
                    assert n <= left, "recv(%d) returned {:d} bytes".format(left, n)
                    buf.write(data)
                    buf_len += n
                    del data  # explicit free
...
class CherryPyWSGIServer(object):
    ...
    def __str__(self):
        return "{}.{}({!r})".format(self.__module__, self.__class__.__name__,
                              self.bind_addr)
    ...
    def tick(self):
        ...
        try:
            ...
            if environ.get("SERVER_SOFTWARE") is None:
                environ["SERVER_SOFTWARE"] = "{} WSGI Server".format(self.version)
...
##            'SSL_SERVER_V_END': Validity of server's certificate (end time),
        ...
        for prefix, dn in [("I", cert.get_issuer()),
            ...
            wsgikey = 'SSL_SERVER_{}_DN'.format(prefix)
