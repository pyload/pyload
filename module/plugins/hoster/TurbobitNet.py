...
class TurbobitNet(SimpleHoster):
    ...
    __pattern__ = r'https?://(?:(?:www|m)\.)?(?:(?:trbbt|turbo(?:beet|bit[ea]?))\.net|(?:tourbobit|turbobi(?:tn?|f))\.com|turbo?\.(?:to|cc)|turb\.pw|trbt\.cc)/(?:download/free/)?(?P<ID>\w+)'
    ...
    def solve_captcha(self):
        ...
        if inputs is None:
            ...
            if captcha_key:
                ...
                self.fail(_("Could not detect captcha type"))
