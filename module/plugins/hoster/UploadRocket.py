...
class UploadRocket(XFSHoster):
    __name__    = "UploadRocket"
    __type__    = "hoster"
    __version__ = "0.01"
    __status__  = "testing"
    ...
    def _post_parameters(self):
        inputs = super(UploadRocket, self)._post_parameters()
    ...
    def process(self, pyfile):
        ...
        super(UploadRocket, self).process(pyfile)
    ...
    def download(self, url, get={}, post={}, ref=True, cookies=True, disposition=True, resume=None, chunks=None):
        ...
        super(UploadRocket, self).download(url, get, post, ref, cookies, disposition, resume, chunks)