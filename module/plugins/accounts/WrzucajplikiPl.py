...
from ..internal.misc import parse_html_form, parse_time


class WrzucajplikiPl(Account):
    ...
    VALID_UNTIL_PATTERN = ur">Twoje premium wygaśnie za :</span>\s*</span>\s*<span>(.+?)<"
    ...
    def grab_info(self, user, password, data):
        ...
        if m is not None:
            validuntil = now + parse_time(m.group(1))
