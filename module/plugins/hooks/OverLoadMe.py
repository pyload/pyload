...
class OverLoadMe(MultiHoster):
    ...
    def getHoster(self):
        ...
        page = getURL(https + "://api.over-load.me/hoster.php?auth=0001-cb1f24dadb3aa487bda5afd3b76298935329be7700cd7-5329be77-00cf-1ca0135f").replace("\"","").strip()
        self.logWarning("Hosterlist %s " % page)
