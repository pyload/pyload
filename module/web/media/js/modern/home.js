...
function LinkEntry(id){
    ...
    this.insert = function(item){
        try{
            ...
            //$(progress).addClass('progress-bar progress-bar-success progress-bar-striped active');
            ...
            $(pgb).addClass('progress-bar progress-bar-success progress-bar-striped active');
