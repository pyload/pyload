...
class Configure(Command):
    ...
    Prepare for build
    """
    _ABOUTFILE = 'src/pyload/requests/__about__.py'
...
__package__ = 'pyload.requests'
__package_name__ = 'pyload.requests'
__version__ = '{0}'
...
setup(
    name='pyload.requests',
    version=read_text('VERSION'),
    description='pyLoad Requests Module',
