...
CURRENT_INTERNAL_VERSION = '2021-01-28'         # YYYY-MM-DD, append a lowercase letter for a new version on the same day
...
class main(QObject):
    ...
    def messageBox_13(self):
        ...
        text += "<br><i>" + _("This may not work as expected when the server is running on a Windows OS.") + "</i>"
        return self.msgBoxYesNo(text, "Q")
