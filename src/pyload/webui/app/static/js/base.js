...
document.addEvent("domready", function() {
  ...
  $('action_play').addEvent('click', () => new Request({method: 'get', url: '{{ url_for("api.unpauseServer") }}'}).send());
  $('action_cancel').addEvent('click', () => new Request({method: 'get', url: '{{ url_for("api.stopAllDownloads") }}'}).send());
  $('action_stop').addEvent('click', () => new Request({method: 'get', url: '{{ url_for("api.pauseServer") }}'}).send());
