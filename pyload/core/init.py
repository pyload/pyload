...
from ..utils.check import ismodule
from ..utils.fs import availspace, fullpath, makedirs
from ..utils.misc import get_translation
from ..utils.system import (ionice, renice, set_process_group,
    ...
    def _init_cache(self):
        ...
        if tempdir is None:
            ...
            if tempdir is None or not os.path.isdir(tempdir):
                pydir = os.path.join(TMPDIR, __package__)
