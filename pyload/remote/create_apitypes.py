...
def main():
    ...
    with io.open(os.path.join(path, "pyload.thrift"), "rb") as f:
        tf = f.read()
    ...
    with nested(io.open(os.path.join(path, "apitypes.py"), "wb"),
                io.open(os.path.join(path, "apitypes_debug.py"), "wb")) as (f, dev):
