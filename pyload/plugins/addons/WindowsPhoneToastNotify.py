...
class WindowsPhoneToastNotify(Hook):
    ...
    def getXmlData(self):
        myxml = "<?xml version='1.0' encoding='utf-8'?> <wp:Notification xmlns:wp='WPNotification'> <wp:Toast> <wp:Text1>Pyload Mobile</wp:Text1> <wp:Text2>Captcha waiting!</wp:Text2> </wp:Toast> </wp:Notification>"
        return myxml
    ...
    def newCaptchaTask(self, task):
        self.logDebug("doing request")
        if not self.getConfig("pushId"):
            return False
